package com.wangtiansoft.KingDarts.common.encrypt;
...
public abstract class ConvertUtils {
    ...
    public static java.util.Date sqlTimestampToDate(Timestamp t){
        ...
        return t != null ? new java.util.Date(Math.round((float)t.getTime() + (float)t.getNanos() / 1000000D)) : null;
    }
    ...
    public static double roundNumber(float rowNumber, int roundingPoint)
    {
        double base = Math.pow(10, roundingPoint);
...
//    {
//    	System.out.println(getDateStart(new java.com.wangtiansoft.bwl.server.util.Date()));
//    }
}
