...
public class HttpUtil {
	...
	public static String post(String url, String body)
		...
		return post(url, body, "application/json", "utf-8",null, 30000, 30000);

	}
	public static String post(String url, String body, Map<String, String> headers)
			throws ConnectTimeoutException, SocketTimeoutException, Exception {
		
		return post(url, body, "application/json", "utf-8",headers, 30000, 30000);
	 ...
	 * @throws Exception
	 */
	public static String post(String url, String body, String mimeType, String charset,  Map<String, String> headers,Integer connTimeout,
...
//			throw new OpenAPIException(JSONObject.parseObject(result));
	...
	public static String get(String url, Map<String, String> params, Map<String, String> headers) throws Exception {
		return get(url, DEFAULT_CHARSET,params,headers, null, null);
	}
	
	public static String get(String url, String charset, Map<String, String> params, Map<String, String> headers, Integer connTimeout, Integer readTimeout)
			throws ConnectTimeoutException, SocketTimeoutException, Exception {
		HttpClient client = null;
	 ...
	 * @throws Exception
	 */
	public static String postFileForm(String url, Map<String, String> params, Map<String, String> headers,List<String> files,String fileParamName)
			throws ConnectTimeoutException, SocketTimeoutException, Exception {
		HttpClient client = null;
		...
		try {
			...
			if(files !=null && !files.isEmpty()){
				for (String filePath : files) {  
					builder.addBinaryBody(fileParamName, new File(filePath));  
				}
			}
