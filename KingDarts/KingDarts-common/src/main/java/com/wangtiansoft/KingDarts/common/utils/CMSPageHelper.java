...
import com.wangtiansoft.KingDarts.common.bean.PageResult;
...
public class CMSPageHelper {
    ...
    //  必须先调用分页方法
    public static CMSPageHelper startPage(Integer pageNum, Integer pageSize){
        CMSPageHelper helper = new CMSPageHelper();
    ...
    //  多查询一条数据，如果数量不足，则返回没有下一页
    public static <T> PageResult<T> build(CMSPageHelper helper, List<T> page){
