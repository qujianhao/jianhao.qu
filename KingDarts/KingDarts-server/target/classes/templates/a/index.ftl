...
<#include "./a/commons/header.ftl" />
<#include "./a/commons/sidebar.ftl" />
    <div class="content-wrapper" style="height: calc(100% - 100px);overflow: hidden;">
        <iframe id="mainFrame" name="mainFrame" src="${base}/a/main" width="100%" height="100%" frameborder="0"></iframe>
    </div>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2017-2018 凯帝狮.</strong> All rights
        reserved.
    </footer>
</div>
