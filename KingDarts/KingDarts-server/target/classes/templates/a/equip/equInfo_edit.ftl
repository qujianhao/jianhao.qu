                ...
                <section class="form-horizontal">
                    ...
                    <div class="row">
                            <div class="col-sm-4 form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="equno" id="equno" value="${entity.equno}" maxlength="30" readonly="readonly" required>
                                </div>
                            </div>
                            <div class="col-sm-4 form-group">
                                <label class="col-sm-4 control-label" for="models"><span style="color:red">*</span>设备型号</label>
                                <div class="col-sm-8">
                                	<select class="form-control" name="models" id="models" data-wt-auto="${entity.models}" required>
                            ...
                            <div class="col-sm-4 form-group">
                                ...
                                <div class="col-sm-8">
                                	<select class="form-control" name="equname" id="equname" data-wt-auto="${entity.equname}" required disabled="disabled">
                            ...
                            <div class="col-sm-4 form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="prod_batch" id="prod_batch" value="${entity.prod_batch}" maxlength="30" placeholder="请输入生产批次" title="请输入生产批次" >
                                </div>
                            </div>
                            <div class="col-sm-4 form-group">
                                <label class="col-sm-4 control-label" for="equ_version"><span style="color:red">*</span>使用版本</label>
                                <div class="col-sm-8">
                                	<select class="form-control" name="equ_version" id="equ_version" data-wt-auto="${entity.equ_version}" required>
    ...
    $("document").ready(function () {
        ...
        $(".wt-save").click(function () {
            ...
            WT.wt_confirm('是否保存?', function () {
                ...
                WT.wt_ajax_form('${base}/a/equInfo/equInfo_edit','layerForm',function(data){
