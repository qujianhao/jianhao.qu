(function ($) {
    $.fn.extend({
        "wtchecktable": function (options, args) {
    ...
    var Controller = function (input, options) {
        ...
        this.options = $.extend({}, {
            ...
            formatName: $input.attr('data-wt-name') || 'wt_checktable',
    ...
    var _fetchData = function (controller) {
        ...
        WT.wt_ajax_formdata_silent(url, params, function (resp) {
            if (resp.data != null) {
                ...
                _errorMsg.apply(that, ['wtchecktable请求失败'])
            }
        });
    }
    var _layoutReversalTables = function (data, controller) {
        ...
        var $elementTable = $('<table class="wt-table wt-checktable"></table>');
