...
<link rel="stylesheet" href="${base}/assets/plugins/jqGrid/1.0.0/ui.jqgrid.css">
<link rel="stylesheet" href="${base}/assets/plugins/bootstrap-datetimepicker/bootstrap-datetimepicker.min.css">
