...
<section class="content">
    <form method="post" name="frameForm" id="frameForm" action="${base}/a/clubInfo/clubInfo_list">
    ...
    $("document").ready(function () {
        ...
        $(".jqGrid_wrapper").on('click', '.wt-delete', function () {
            ...
            WT.wt_confirm('是否删除?', function () {
                WT.wt_ajax_jsondata('${base}/a/clubInfo/clubInfo_delete', params, function (data) {
                    WT.wt_alert('删除成功');
