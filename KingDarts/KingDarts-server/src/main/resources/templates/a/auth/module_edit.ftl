    ...
    <div class="wt-layer-footer">
        <div class="col-sm-12 wt-layer-footer-content wt-btns-center">
            <input type="hidden" name="id" id="id" value="${entity.id}"/>
             <@wtAuth hasPrem="_MODULE:EDIT" ><button type="button" class="btn btn-sm btn-info wt-save">保存</button></@wtAuth>
    ...
    $("document").ready(function () {
        ...
        $(".wt-save").click(function () {
            ...
            WT.wt_confirm('是否保存?', function () {
                WT.wt_ajax_form('${base}/a/module/module_edit','layerForm',function(data){
        ...
        $(".wt-icon-picker").click(function () {
            WT.wt_open_layer('${base}/a/module/module_icon_list');
        });
    });
</script>
</body>
