...
import com.wangtiansoft.KingDarts.persistence.dao.master.GameMapper;
...
@Transactional
@Service("gameService")
public class GameServiceImpl extends BaseService<Game, Integer> implements GameService{
    ...
    @Override
    public Page<Map> queryGamePageList(Map paramMap, PageBean pageBean) {
        paramMap.put(SQLUtil.SQL_OrderSQL, SQLUtil.orderByCondition(pageBean));
        PageHelper.startPage(pageBean.getPage(), pageBean.getRows());
        return (Page<Map>) gameMapper.queryGameList(paramMap);
    }
